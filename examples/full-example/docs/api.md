<!-- Generated by full-example docs api --save; do not edit. -->
...
- `status` — Show resolved config and app version.
...
- `configure` — Set up agent skills, MCP config, and app config for this app (binary via Homebrew).
- `docs` — Print bundled CLI documentation.
- `mcp` — MCP server and bundle tools.
- `api` — HTTP API server for tools.
...
Set up agent skills, MCP config, and app config for this app (binary via Homebrew).
...
| Option | Type | Required | Format / default | Description |
| --- | --- | --- | --- | --- |
| `--sync` | flag | optional | — | Refresh installed skills, MCP, and config. Used by Homebrew post_install. |
| `--remove-all` | flag | optional | — | Remove all detected agent artifacts (skills and MCP). |
| `--remove-config` | flag | optional | — | Remove the app config file only. |
...
- `get` — Print resolved configuration value(s).
- `set` — Write one configuration key to the config file.

##### `full-example echo configure get`

Print resolved configuration value(s).

#### Options

| Option | Type | Required | Format / default | Description |
| --- | --- | --- | --- | --- |
| `--json` | flag | optional | — | Emit JSON (compact). |
| `--pretty` | flag | optional | — | Pretty-print JSON (requires --json). |

##### `full-example echo configure set`

Write one configuration key to the config file.
...
| --- | --- | --- | --- | --- |
| `--json` | flag | optional | — | Emit JSON (compact). |
| `--from-env` | flag | optional | — | Bind this key to its mapped environment variable (no literal value stored). |
...
**Default subcommand:** `readme` (`missingOnly`)
...
- `api` — Print the full command reference as markdown.
...
Show resolved config and app version.
...
##### `full-example status configure get`
...
##### `full-example status configure set`
